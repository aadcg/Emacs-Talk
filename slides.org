...
#+property: header-args:py :results output
...
*** Example 2
:PROPERTIES:
:header-args:sh: :dir /ssh:aadco@login.mindstorm.vestas.net|ssh:aadco@ac003:~/
:END:
...
*** Mindstorm
:PROPERTIES:
:header-args:sh: /ssh:aadco@login.mindstorm.vestas.net:~/
:END:
